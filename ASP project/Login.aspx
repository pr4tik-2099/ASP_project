                      ...
                      <form runat="server">
                        ...
                        <div class="col form-floating mb-3">
                          <div class="form-group">
                              ...
                              <center>
                                  <asp:TextBox ID="TextBox1" runat="server" CssClass="Txt_box form-control" SkinID="floatingInput">
                                  </asp:TextBox>
                              </center>
                          </div>
                      </div>
                        ...
                        <div class="col form-floating mb-3">
                          <div class="form-group">
                              ...
                              <center>
                                  <asp:TextBox ID="TextBox2" runat="server" CssClass="Txt_box form-control" SkinID="floatingInput" TextMode="Password">
                                  </asp:TextBox>
                              </center>
                          </div>
                      </div>
                          ...
                          <div class="form-group l_btn">
                              <center>
                                 <a href="Sign_Up_Page.aspx"> <input id="signup_btn" type="button" value="Sign Up" class="btn lbtn btn-info"/> </a>
